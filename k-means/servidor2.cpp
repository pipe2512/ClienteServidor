...
void calculaK(size_t limiteK){
    ...
    while(parada == false)
    {
      ...
      cout << "Respuesta = " << respuesta_solicitud << endl;
      if(respuesta_solicitud != "hola"){
        ...
        cout << "condicion: anterior" << kAnterior << " siguiete: " << kSiguiente << " tamano cola: " << colaPrioridad.size() <<endl;
      ...
      while(entrada == false){
        ...
        cout << "entre al ciclo -> " << numCentroides << endl;
